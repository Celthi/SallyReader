...
var ChapterReader_1 = require("./ChapterReader");
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var bookUrl, url, referer, options_1, booksFolder_1, book, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                referer = 'https://learning.oreilly.com/library/view/head-first-design/0596007124/ch10.html';
                options_1 = {
                ...
                booksFolder_1 = './books/';
                return [4, BookReader_1.readBookCover(bookUrl, options_1, booksFolder_1)];
            case 1:
                book = _a.sent();
                BookReader_1.chaptersFromBook(book.html).forEach(function (chapterUrl) {
                    ChapterReader_1.readChapter(chapterUrl, options_1, booksFolder_1);
                });
                return [3, 3];
            case 2:
                error_1 = _a.sent();
