...
var ImageReader_1 = require("../src/ImageReader");
var fs_1 = __importDefault(require("fs"));
describe('read a image', function () {
    it('should read a image', function () {
        var url = 'https://learning.oreilly.com';
        var referer = 'https://learning.oreilly.com/library/view/head-first-design/0596007124/ch10.html';
        var imageUrl = '/library/view/head-first-design/0596007124/figs/web/425fig01.png.jpg';
        var options = {
