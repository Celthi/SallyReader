...
const imgUrl = 'https://learning.oreilly.com/library/view/head-first-design/0596007124/figs/web/425fig01.png.jpg';
const path = '/library/view/head-first-design/0596007124/figs/web/425fig01.png.jpg';
const fs = require('fs');
const options = {
...
const request = http2.request(options, response => {
    ...
    response.on('end', () => {
        const imgLocation = 'img.jpg'
        fs.writeFile(imgLocation, Buffer.concat(body), function (error) {
            console.log(error);
        });
    });
});
