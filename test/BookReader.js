...
const BookReader_1 = require("../src/BookReader");
describe('read book', () => {
    it('should read book', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        BookReader_1.chaptersFromBook(yield BookReader_1.readBookCover(bookUrl, options, './tmp/books/')).forEach((element => {
            console.log(element);
        }));
    }));
});
